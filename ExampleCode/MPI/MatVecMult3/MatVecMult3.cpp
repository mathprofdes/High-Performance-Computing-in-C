...
int main(int argc, char *argv[]) {
	int commsz, rank, rows, cols, padrows;
	double starttime, endtime;
	double *A = NULL, *localA = NULL;
	double *y = NULL, *yp = NULL, *lyp = NULL, *x = NULL;
	...
	if (rank == 0) {
		...
		cout << "Input m, number of matrix rows: ";
		cin >> rows;
	...
	MPI_Gather(lyp, padrows / commsz, MPI_DOUBLE, yp, padrows / commsz,
