...
//	MPI_Bcast(&n, 1, MPI_INT, 0, MPI_COMM_WORLD);
	...
	// Calculate the processor's portion of pi. Processor may not have the
	// value of n yet and hence the reduction may have only a partial result.
	...
	// Synchronize the broadcast of n to all processors.
	// Calculation should be valid at this point.
	...
	if (rank == 0) {
		printf("After wait: Parallel pi is approximately %.16f, Error is %.16f\n", piapprox,
				fabs(piapprox - PI25DT));
	}
