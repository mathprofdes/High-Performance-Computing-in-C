...
int main(int argc, char **argv) {
	...
	blocks[0] = 1;
	types[0] = MPI_CHAR;
	displacements[0] = (size_t) &(obj.c) - (size_t) &obj;

	blocks[1] = 2;
	types[1] = MPI_DOUBLE;
	displacements[1] = (size_t) &(obj.x) - (size_t) &obj;

	blocks[2] = 1;
	types[2] = MPI_INT;
	displacements[2] = (size_t) &(obj.i) - (size_t) &obj;
	...
	if (rank == 0) {
		...
		MPI_Recv(&obj, 1, structtype, 0, 0, MPI_COMM_WORLD,
		MPI_STATUS_IGNORE);
